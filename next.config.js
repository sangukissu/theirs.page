  ...
  async headers() {
    ...
    const securityHeaders = [
      ...
      // Content Security Policy to prevent XSS attacks
      {
        ...
        value: [
          "default-src 'self'",
          `script-src 'self'${isProduction ? '' : " 'unsafe-eval'"} 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://challenges.cloudflare.com https://www.clarity.ms https://*.clarity.ms https://client.crisp.chat https://settings.crisp.chat`,
