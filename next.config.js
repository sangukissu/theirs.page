  ...
  async headers() {
    ...
    const securityHeaders = [
      ...
      // Content Security Policy to prevent XSS attacks
      {
        ...
        value: [
          "default-src 'self'",
          `script-src 'self'${isProduction ? '' : " 'unsafe-eval'"} 'unsafe-inline' https://c.ecompin.com https://*.ecompin.com https://cloud.umami.is https://*.umami.is https://challenges.cloudflare.com https://static.cloudflareinsights.com https://*.cloudflareinsights.com https://client.crisp.chat https://settings.crisp.chat`,
          "script-src-elem 'self' 'unsafe-inline' https://c.ecompin.com https://*.ecompin.com https://cloud.umami.is https://*.umami.is https://challenges.cloudflare.com https://*.cloudflare.com https://static.cloudflareinsights.com https://*.cloudflareinsights.com https://client.crisp.chat https://settings.crisp.chat",
          "style-src 'self' 'unsafe-inline' https://client.crisp.chat",
          "img-src 'self' data: https: blob: https://*.crisp.chat https://i.ytimg.com https://*.ytimg.com",
          "font-src 'self' data: https://client.crisp.chat",
          "connect-src 'self' https://c.ecompin.com https://*.ecompin.com https://cloud.umami.is https://*.umami.is https://blog.theirs.page https://api.supabase.co https://*.supabase.co wss://*.supabase.co https://fal.ai https://*.fal.ai https://*.fal.media wss://*.fal.ai https://dodopayments.com https://*.dodopayments.com https://*.r2.cloudflarestorage.com https://challenges.cloudflare.com https://*.cloudflare.com https://cloudflareinsights.com https://*.cloudflareinsights.com https://client.crisp.chat https://storage.crisp.chat wss://client.relay.crisp.chat wss://stream.relay.crisp.chat",
