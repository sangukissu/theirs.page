...
import { ScanLine, Sparkles, Droplets, Wand2, Palette, Image as ImageIcon } from 'lucide-react';
...
const CASE_STUDIES: CaseStudy[] = [
  {
    id: 'water-damage',
    title: 'Fix Water Damage & Fading',
    description: 'Reverse the effects of humidity and sunlight. Our AI reconstructs parts of the image lost to water stains, mold spots, or severe sepia fading.',
  ...
  {
    id: 'scratches',
    title: 'Remove Scratches, Tears & Creases',
    description: 'Automatically detect and fill in scratches, dust spots, and tears caused by folding. Perfect for scanned photos that have been stored in boxes for decades.',
    icon: <Wand2 size={24} />,
  ...
  {
    id: 'blur',
    title: 'Deblur Faces & Sharpen Details',
    description: 'Enhance blurry old photos instantly. We use facial landmark reconstruction to bring focus back to eyes, smiles, and facial features.',
  ...
  },
  {
    ...
    description: 'Add realistic, natural colors to grayscale images. Turn your grandparents\' wedding photos into vibrant memories.',
...
const ComparisonSlider: React.FC<{ before: string; after: string; active: boolean }> = ({ before, after, active }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full h-full min-h-[400px] lg:min-h-[600px] overflow-hidden rounded-[1.5rem] cursor-ew-resize select-none group"
...
export const Showcase: React.FC = () => {
  ...
  return (
    <section id="showcase" className="w-full max-w-[1320px] mx-auto px-4 sm:px-8 py-24 bg-brand-bg">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
        ...
        <div className="max-w-sm">
          <p className="text-lg text-gray-600 font-medium leading-relaxed">
            Our restoration engine detects and fixes specific photo issues that happen over time.
          </p>
        </div>
      </div>
