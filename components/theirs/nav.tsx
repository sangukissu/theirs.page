...
export function TheirsNav() {
  return (
    <header className="sticky top-0 z-50 h-14 w-full px-4 sm:h-16 sm:px-6 pt-3">
      <div className="relative mx-auto flex h-11 sm:h-12 w-full max-w-2xl items-center justify-between rounded-full border border-[#8f8f8f]/30 bg-[#d9d9d9]/50 px-4 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.08)]">
        {/* Clean Wordmark: Theirs. */}
        <Link href="/" className="flex items-center group">
          <span className="font-semibold tracking-tight text-[#181925] text-base">
            Theirs<span className="text-primary">.</span>
          </span>
        </Link>

        {/* Center Links */}
        <div className="hidden sm:flex items-center gap-6 text-xs font-medium text-[#666]">
