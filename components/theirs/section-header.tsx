...
export function SectionHeader({
  ...
  return (
    <div className={`flex flex-col items-center text-center gap-4 sm:gap-5 ${className}`}>
      <span
        data-slot="badge"
        className="flex items-center justify-center border font-medium w-fit whitespace-nowrap border-transparent bg-neutral-100 text-[#666] h-[24px] min-w-[24px] text-xs px-2.5 rounded-full select-none"
      >
        {badge}
      </span>
