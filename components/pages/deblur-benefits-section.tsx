...
export default function DeblurBenefitsSection() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-12">
            <div className="border-l-2 border-gray-200 pl-8">
              <h3 className="text-2xl font-bold text-black mb-3">Intelligent Sharpening</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                Advanced AI sharpens subjects and recovers details while keeping backgrounds smooth. No more
                fake-looking "sharpen" filters.
              </p>
              <div className="text-sm text-gray-500">⚡ Results in under 30 seconds</div>
            </div>

            <div className="border-l-2 border-gray-200 pl-8">
              <h3 className="text-2xl font-bold text-black mb-3">Fixes All Kinds of Blur</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                Motion blur, out-of-focus moments, low-light softness. Easily fix the blur and bring your photos to the
                next level of clarity.
              </p>
              <div className="text-sm text-gray-500">✨ All blur types supported</div>
            </div>

            <div className="border-l-2 border-gray-200 pl-8">
              <h3 className="text-2xl font-bold text-black mb-3">Fair & Simple Pricing</h3>
              <p className="text-gray-600 leading-relaxed mb-4">
                 One-time payment, not another subscription trap. Just $4.99 for 4 high-quality photo enhancements.
              </p>
            ...
            <div className="bg-gray-50 rounded-3xl p-12 border border-gray-200 text-center max-w-sm w-full">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Photo enhancements</span>
