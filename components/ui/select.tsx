  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="size-4 text-[#888] shrink-0 transition-transform duration-200" />
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("text-[#888] px-3 py-1.5 text-xs font-medium", className)}
      {...props}
    />
  )
}
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center rounded-xl py-2 pl-3 pr-8 text-sm text-[#181925] outline-hidden select-none transition-colors hover:bg-neutral-100/80 focus:bg-neutral-100/80 focus:text-[#181925] data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[state=checked]:font-medium data-[state=checked]:bg-primary/[0.06] data-[state=checked]:text-primary [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      {...props}
    >
