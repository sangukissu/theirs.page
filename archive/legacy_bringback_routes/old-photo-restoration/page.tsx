...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://theirs.page/old-photo-restoration",
  },
  openGraph: {
    ...
    url: "https://theirs.page/old-photo-restoration",
    siteName: "BringBack",
    type: "website",
    images: [
      {
...
const webAppJsonLd = {
  ...
  "@type": "WebApplication",
  "@id": "https://theirs.page/old-photo-restoration#webapp",
  ...
  step: [
    {
      ...
      url: "https://theirs.page/old-photo-restoration#how-it-works",
    },
    {
      "@type": "HowToStep",
      position: 2,
