...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://theirs-page.sangukissu.workers.dev/colorize-photos",
  },
  openGraph: {
    ...
    url: "https://theirs-page.sangukissu.workers.dev/colorize-photos",
    siteName: "BringBack",
    type: "website",
    images: [
      {
...
const webAppJsonLd = {
  ...
  "@type": "WebApplication",
  "@id": "https://theirs-page.sangukissu.workers.dev/colorize-photos#webapp",
  ...
  step: [
    {
      ...
      url: "https://theirs-page.sangukissu.workers.dev/colorize-photos#how-it-works",
    },
    {
      "@type": "HowToStep",
      position: 2,
