...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://theirs.page/denoise-photos",
  },
  openGraph: {
    ...
    url: "https://theirs.page/denoise-photos",
    siteName: "BringBack",
    type: "website",
    images: [
      {
...
const webAppJsonLd = {
  ...
  "@type": "WebApplication",
  "@id": "https://theirs.page/denoise-photos#webapp",
  ...
  step: [
    {
      ...
      url: "https://theirs.page/denoise-photos#how-it-works",
    },
    {
      "@type": "HowToStep",
      position: 2,
