...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://theirs-page.sangukissu.workers.dev/ai-photo-animation",
  },
  openGraph: {
    ...
    url: "https://theirs-page.sangukissu.workers.dev/ai-photo-animation",
    siteName: "BringBack",
    type: "website",
    images: [
      {
...
const webAppJsonLd = {
  ...
  "@type": "WebApplication",
  "@id": "https://theirs-page.sangukissu.workers.dev/ai-photo-animation#webapp",
  ...
  step: [
    {
      ...
      url: "https://theirs-page.sangukissu.workers.dev/ai-photo-animation#how-it-works",
    },
    {
      "@type": "HowToStep",
      position: 2,
